    ...
    function init() {
        class RestaurantsManager {
            ...
            get categories() {
                ...
                //let nextIndex = 0;
                // Referencia al array que se usara en el closure
                let array = this.#categories;
                return {
                    * [Symbol.iterator]() { // Metodo generador para la iteracion
                        // Bucle for para iterar sobre el array de categories
                        for (let i = 0; i < array.length; i++){
                            // Devuelve el elemento actual del array en cada iteracion, pausandose hasta la siguiente llamada
                            yield array[i];
                        }
                    },
                };
  ...
  /*          changeDishesPositionsInMenu(menu, dish1, dish2) {
            ...
            * categoryCondition(category, condition){ 
            ...
            createDish(name, description, ingredients = [], image = "") {
                // Valida el parámetro obligatorio
                if (!name) {
                    throw new EmptyValueException('name');
                }           
                ...
                if (existingDish !==-1) {
                    ...
                    return this; //.#dishes[existingDishIndex]
                } else {
